...
for an FX, a mapping is created automatically. In this case all
parameters are processed as continuous (so that the \vpots are unused
for FXs without user-created maps).
