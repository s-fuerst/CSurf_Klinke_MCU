...
the Dry/Wet level, holding the \shift modifier and pressing \flip
toggles delta solo and holding the \option modifier and pressing \flip
...
\item \gv: see \select
\item \flip: Bypass
\item \shift \flip: Delta Solo
\item \option \flip: Toggle 0/100\% Dry/Wet level.
