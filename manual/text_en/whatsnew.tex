...
\item Extender support: up to eight MCU-protocol units (one main plus
  ...
  count, and in the FX-Mode the banks and pages can be cascaded across
  the units (see section~\ref{plugcascade}).
\item Cross-platform: the extension now builds and runs on Windows,
  macOS\,(10.15+) and Linux, in addition to the original Windows-only
  build.
