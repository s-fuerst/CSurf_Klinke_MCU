...
*/
class PlugModeVPOTTableComponent : public Component, public TableListBoxModel {
public:
  //==============================================================================
  ...
  void setLastChangedRow(int row) {
  ...
  // This is overloaded from TableListBoxModel, and must paint any cells that
  // aren't using custom components.
  ...
  //              g.setFont (font);
  //
  //              const XmlElement* rowElement = dataList->getChildElement
  //              (rowNumber);
  //
  //              if (rowElement != 0)
  //              {
  //                      const String text (rowElement->getStringAttribute
